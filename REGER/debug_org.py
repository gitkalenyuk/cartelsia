...
async def main():
    email = "mse0j9lorocf18@furia.ink"
    password = "Oc7^*vJN2j8N5Iv1U5"
    ...
    async with async_playwright() as p:
        ...
        await page.screenshot(path="org_select_debug.png", full_page=True)
        
        # Save HTML for analysis
        html = await page.content()
        with open("org_select_debug.html", "w", encoding="utf-8") as f:
            f.write(html)
        
        print("Saved org_select_debug.png and org_select_debug.html")
